      ...
      <div class="box-body">
       ...
       <div class="vp-chart-container">
         ...
         <div class="table-responsive">
           <table class="table table-bordered table-striped table-condensed dt-responsive" id="tablaResumenProductosVenta" width="100%">
             <thead>
...
// DataTable para el resumen agregado por producto
var tablaResumenProductosVenta = $("#tablaResumenProductosVenta").DataTable({
    "order": [[ 3, "desc" ]], // ordenar por venta total
    "pageLength": 25,
    "language": {
        "sProcessing":     "Procesando...",
        "sLengthMenu":     "Mostrar _MENU_ registros",
