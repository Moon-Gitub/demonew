                  ...
                  <div class="input-group">
                    <span title="Listas de precio" class="input-group-addon" style="background-color: #ddd">Listas $</span>
                      ...
                      if (class_exists('ModeloListasPrecio') && ModeloListasPrecio::tablaExiste()) {
                        ...
                        $listasPrecioConfigPresup = ModeloListasPrecio::mdlConfigPorCodigos(!empty($_SESSION['listas_precio']) ? $_SESSION['listas_precio'] : 'precio_venta');
                      } else {
                        $arrListasPrecio = ['precio_venta' => 'Precio Público'];
                        $listasPrecioConfigPresup = [];
                      }
...
<div id="modalAgregarCliente" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <input type="hidden" name="agregarClienteDesde" value="crear-presupuesto-caja">
        <!--=====================================
        CABEZA DEL MODAL
        ======================================-->
          ...
          <hr>
            ...
            Detalle
             <br>
              ...
              <div style="text-align: center">Presupuesto válido por 10 días</div> 
