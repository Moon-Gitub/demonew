...
<center><button type="button" onclick="imprmir()" class="btn btn-primary" >Imprimir Pro </button></center>
        ...
        <div class="modal-body">
          <div class="card-body">
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-list-ul"></i></span> 
                <select class="form-control " name="nuevoCondicionIva" id="vtanuevoCondicionIva">
