<?php
// vistas/modulos/productos-desactivados.php
?>
...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      ...
      <small>Reactivar productos dados de baja</small>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <p class="text-muted" style="margin-top:8px;">
          Aquí se muestran los productos que fueron desactivados. Podés volver a activarlos para que vuelvan a aparecer en los listados y en las ventas.
        </p>
      </div>
      <div class="box-body">
...
$(function() {
  ...
  var $tabla = $('#tablaProductosInactivos');
  if (!$tabla.length) {
    return;
  }
  ...
  // Activar producto
  $tabla.on('click', '.btnActivarProducto', function(e) {
    e.preventDefault();
