...
<div class="content-wrapper informes-stock">
  <section class="content-header">
    <h1><i class="fa fa-area-chart"></i> Informes <small>Productos con stock medio</small></h1>
    <ol class="breadcrumb">
      <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
      <li><a href="productos-stock-bajo">Informes</a></li>
      <li class="active">Stock medio</li>
    </ol>
  </section>
  ...
  <section class="content">
    <style>
      ...
      .informes-stock #tablaStockMedio thead tr:first-child { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; }
      .informes-stock #tablaStockMedio thead th { color: white; font-weight: 600; text-transform: uppercase; border: none; padding: 12px 8px; }
    ...
    <div class="row vp-summary-row">
      <div class="col-md-4 col-sm-6">
        <div class="inf-card">
          <div class="inf-card-title">Productos con stock medio</div>
          <div class="inf-card-value"><?php echo $cantidad; ?></div>
          <div class="inf-card-sub">Cantidad de ítems en rango medio</div>
        </div>
      </div>
      <div class="col-md-4 col-sm-6">
        <div class="inf-card">
          ...
          <div class="inf-card-sub">Suma del stock actual</div>
        </div>
      </div>
      <div class="col-md-4 col-sm-6">
        <div class="inf-card">
          <div class="inf-card-title">Acción</div>
          <div class="inf-card-value" style="font-size: 16px;"><i class="fa fa-eye text-info"></i> Monitorear</div>
          <div class="inf-card-sub"><a href="productos-stock-bajo">Stock bajo</a> · <a href="productos">Productos</a></div>
        </div>
      </div>
    </div>
    ...
    <div class="box">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped dt-responsive tablasBotones" id="tablaStockMedio" width="100%">
          <thead>
            <tr>
              <th>Código</th>
              <th>Descripción</th>
