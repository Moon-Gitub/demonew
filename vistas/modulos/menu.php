...
$verProductos = _menuPuedeVer('productos') || _menuPuedeVer('categorias') || _menuPuedeVer('combos') || _menuPuedeVer('impresion-precios') || _menuPuedeVer('productos-importar-excel2') || _menuPuedeVer('productos-desactivados');
...
<aside class="main-sidebar">
	<section class="sidebar">
		...
		if ($_SESSION["perfil"] == "Administrador") {
			...
			<li class="treeview <?php echo (in_array($paginaActualMenu, ['productos', 'categorias', 'combos', 'impresion-precios', 'productos-importar-excel2', 'productos-desactivados'])) ? 'active' : '' ?>">
