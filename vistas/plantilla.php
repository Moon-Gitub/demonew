     ...
     echo '<input type="hidden" id="tiempoMaximoSesion" value="'.ini_get("session.gc_maxlifetime").'">';
      ...
      if(isset($_GET["ruta"])){
        ...
        if (isset($_SESSION["permisos_pantallas"]) && is_array($_SESSION["permisos_pantallas"])) {
          ...
          // Administrador siempre puede abrir permisos-rol para poder configurar el resto
          ...
          if ($ruta === 'informe-gestion-pedidos' && isset($_SESSION['perfil']) && $_SESSION['perfil'] === 'Administrador') {
            $permiso = true;
          }
        } else {
          $permiso = ($ruta == "inicio" || $ruta == "usuarios" || $ruta == "categorias" || $ruta == "productos" || $ruta == "productos-desactivados" || $ruta == "combos" || $ruta == "productos-stock-medio" || $ruta == "productos-stock-bajo" || $ruta == "productos-stock-valorizado" || $ruta == "productos-historial" || $ruta == "productos-importar-excel" || $ruta == "productos-importar-excel2" || $ruta == "pedidos-validados" || $ruta == "pedidos-nuevos" || $ruta == "crear-venta-caja-impresion" || $ruta == "info" || $ruta == "pedidos-generar-movimiento" || $ruta == "impresion-precios" || $ruta == "impresionPreciosCuidados" || $ruta == "impresionPreciosOfertas" || $ruta == "impresionPreciosCuidadosGrande" || $ruta == "proveedores" || $ruta == "proveedores-cuenta-saldos" || $ruta == "proveedores_cuenta" || $ruta == "proveedores-saldo" || $ruta == "proveedores-pagos" || $ruta == "retenciones-iibb" || $ruta == "integraciones" || $ruta == "chat" || $ruta == "clientes" || $ruta == "editar-pedido" || $ruta == "clientes-cuenta-saldos" || $ruta == "clientes-cuenta-deuda" || $ruta == "clientes_cuenta" || $ruta == "ventas" || $ruta == "ventas-categoria-proveedor-informe" || $ruta == "ventas-productos" || $ruta == "presupuestos" || $ruta == "presupuesto-venta" || $ruta == "crear-presupuesto-caja" || $ruta == "crear-presupuesto-caja2" || $ruta == "libro-iva-ventas" || $ruta == "ventas-rentabilidad" || $ruta == "crear-venta" || $ruta == "crear-venta-caja" || $ruta == "editar-venta" || $ruta == "crear-compra" || $ruta == "ingreso" || $ruta == "editar-ingreso" || $ruta == "compras" || $ruta == "reportes" || $ruta == "informe-dashboard-ejecutivo" || $ruta == "informe-gestion-pedidos" || $ruta == "empresa" || $ruta == "listas-precio" || $ruta == "balanzas-formatos" || $ruta == "permisos-rol" || $ruta == "medios-pago" || $ruta == "cajas" || $ruta == "cajas-cajero" || $ruta == "cajas-cierre" || $ruta == "parametros-facturacion" || $ruta == "factura-manual" || $ruta == "procesar-pago" || $ruta == "salir");
        }
...
?>
  ...
  <script src="vistas/js/venta-caja.js?v=2"></script>
