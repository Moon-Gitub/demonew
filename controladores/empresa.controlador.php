		...
		if(isset($_POST["empRazonSocial"])){
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["empRazonSocial"])){
				...
				$datos = array(
					...
					"agente_retencion_iibb" => isset($_POST["empAgenteRetencionIibb"]) ? 1 : 0,
					"codigo_jurisdiccion_iibb" => isset($_POST["empCodigoJurisdiccionIibb"]) ? (int)$_POST["empCodigoJurisdiccionIibb"] : 913,
					"tipo_regimen_retencion_default" => isset($_POST["empTipoRegimenRetencion"]) ? (int)$_POST["empTipoRegimenRetencion"] : 101,
					"proximo_numero_recibo" => isset($_POST["empProximoNumeroRecibo"]) ? (int)$_POST["empProximoNumeroRecibo"] : 1,
